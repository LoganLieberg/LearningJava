...
public class Animals {
	...
	public Animals() {
		...
		//hasNextInt, hasNextFloat, hasNextDouble...etc
		//nextLine, nextInt, nextFloat...etc
	...
	public void setUniqueID() {
		...
		//below is called casting, specified by the (long) cast to other types by using (int) etc
	...
	public static void speakAnimals(Animals randAnimal){
